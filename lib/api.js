...
/* export function getAllArtistsSlugs() {
...
export async function getAllArtistsSlugs() {
	const data = await fetchAPI(`
		query MyQuery {
			artists {
				edges {
...
/* export function getSingleArtistData(id) {
    ...
    const matchingArtists = artists.find((artist) => {
